...
Cloudflare collects telemetry about your usage of `create-cloudflare` to improve the experience. Read more about our data policy at [/workers/telemetry](/workers/telemetry).
