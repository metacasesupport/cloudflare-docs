...
Cloudflare collects telemetry about your usage of `create-cloudflare` to improve the experience. Read more about our data policy at [https://developers.cloudflare.com/workers/telemetry](https://developers.cloudflare.com/workers/telemetry).

You can opt-out if you'd not like to share any information.
